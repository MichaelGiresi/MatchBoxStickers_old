...
import howItWorks from '../styles/howItWorks/howItWorks.css'
const HowItWorks = () => {
  return (
    ...
    <div className='howItWorks-container'>
      ...
      <div className='howItWorks-image-info-container'>
        ...
        <div className='howItWorks-imagetitle-styles'>Lorem, ipsum dolor.</div>
        <div className='howItWorks-imageparagraph-styles'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Neque iste culpa saepe debitis necessitatibus soluta, exercitationem assumenda officia molestiae eius.</div>

        </div>
        <div className='howItWorks-image-info-container2'>
        <div className='howItWorks-image2'></div>
        <div className='howItWorks-imagetitle-styles' >Lorem, ipsum dolor.</div>
        <div className='howItWorks-imageparagraph-styles'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Neque iste culpa saepe debitis necessitatibus soluta, exercitationem assumenda officia molestiae eius.</div>
        ...
        <div className='howItWorks-image3'></div>
        <div className='howItWorks-imagetitle-styles' >Lorem, ipsum dolor.</div>
        <div className='howItWorks-imageparagraph-styles'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Neque iste culpa saepe debitis necessitatibus soluta, exercitationem assumenda officia molestiae eius.</div>
      ...
      <div className='howItWorks-getdropalerts-container'>
        ...
        <div className='howItWorks-getdropalerts-text-input-inner-container'>
          <div className='howItWorks-getdropalerts-text-container'>
            ...
            <p>Ipsam, iure molestiae! Et officia laboriosam fugit impedit officiis, ipsum eum quisquam.</p>
          </div>
